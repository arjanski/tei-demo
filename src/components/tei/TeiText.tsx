...
import { TeiPersname } from "./TeiPersname";
  ...
  return (
    <div className="prose lg:prose-xl mx-auto max-w-xl p-8 leading-8">
      {domData && facsimiles?.length && (
        <div className="embla overflow-hidden mb-12" ref={emblaRef}>
          ...
          <nav className="flex justify-center gap-x-4">
            <button
              className="embla__prev z-50 inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              onClick={scrollPrev}
            >
              Previous
            </button>
            <button
              className="embla__next z-50 inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              onClick={scrollNext}
            >
              Next
            </button>
      ...
      <TEIRender data={domData}>
        ...
        <TEIRoute el="tei-persname" component={TeiPersname} />
